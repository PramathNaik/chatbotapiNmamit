...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'dca23n9p06pjst',
        'USER': 'llgrbhlvovlext',
        'PASSWORD': '7b04e05445d74298455faa920bd2a058d7b0de39781f8efe601247758c45f06e',
...
SIMPLE_CHATBOT = {
    'responses': (
        ...
        ("main.responses.clubec","clubec"),
        ("main.responses.chaptersec","chaptersec"),
        ("main.responses.lavanyaec","lavanyaec"),
        ("main.responses.harshitaec","harshitaec"),
        ("main.responses.shankariec","shankariec"),
        ("main.responses.ashwiniec","ashwiniec"),
        ("main.responses.ramyaec","ramyaec"),
        ("main.responses.kavithaec","kavithaec"),
        ("main.responses.karthikec","karthikec"),
        ("main.responses.bommegec","bommegec"),
        ("main.responses.prajwalec","prajwalec"),
        ("main.responses.naguec","naguec"),
        ("main.responses.dileepec","dileepec"),
        ("main.responses.anilec","anilec"),
        ("main.responses.shubhaec","shubhaec"),
        ("main.responses.nijuec","nijuec"),
        ("main.responses.charishmaec","charishmaec"),
        ("main.responses.pradymunaec","pradymunaec"),
        ("main.responses.raviec","raviec"),
        ("main.responses.anuec","anuec"),
        ("main.responses.shivakumec","shivakumec"),
        ("main.responses.narendec","narendec"),
